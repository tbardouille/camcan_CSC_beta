...
def MEG_preproc(subjectID):
    ...
    channelIndex = mne.pick_channels(epochs_clean.info["ch_names"], [channelName])
    ...
    n_cycles = freqs / 2.0
    power, _ = tfr_morlet(epochs_no_evoked, freqs=freqs, n_cycles=n_cycles, picks=channelIndex,
