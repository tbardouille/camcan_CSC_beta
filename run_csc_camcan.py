...
#        'Movement-related', 'Rebound', 'u_coef 0', 'u_coef 1','u_coef 2','u_coef 3','u_coef 4', 'u_coef 5', 
#        'u_coef 6', 'u_coef 7', 'u_coef 8', 'u_coef 9', 'u_coef 10', 'u_coef 11','u_coef 12', 'u_coef 13', 
#        'u_coef 14', 'u_coef 15', 'u_coef 16', 'u_coef 17', 'u_coef 18','u_coef 19', 'psd_coef 0', 'psd_coef 1', 
#        'psd_coef 2','psd_coef 3','psd_coef 4', 'psd_coef 5', 'psd_coef 6', 'psd_coef 7', 'psd_coef 8', 
#        'psd_coef 9', 'psd_coef 10', 'psd_coef 11','psd_coef 12', 'psd_coef 13', 'psd_coef 14',
#        'psd_coef 15', 'psd_coef 16', 'psd_coef 17', 'psd_coef 18','psd_coef 19','Unique'])
dataframe_dir = HOME_DIR / "results/atomData.csv"

atomsDf = pd.read_csv(dataframe_dir)

#Set up loop to run subset of camcan subjects
#50 participants selected 
subjects = ['CC221107']
